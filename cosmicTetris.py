...
import random
from cosmicTetrisBoardUtils import TetrisBoardUtils
...
if __name__ == "__main__":
    TetrisBoardUtils.clear_board(graphics)   # Clear board and terminal to begin game
...
for z in range(2000):
    ...
    if cu == None:        
        ...
        TetrisBoardUtils.drawBoardToLEDs(canvas, True, graphics, cu)
...
if cu == None:
    ...
    TetrisBoardUtils.drawBoardToLEDs(canvas, False, graphics, cu)
